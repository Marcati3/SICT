import {
  ...
  forwardHtmlEvents,
  forwardObjectEvents
} from "./chunk-7OGMKMIE.js";
import {
  MeshLineGeometry,
  MeshLineMaterial
} from "./chunk-OMUQAAWX.js";
import {
  create,
  createStore,
  useStore as useStore2
} from "./chunk-QERLWENR.js";
import {
  require_client
} from "./chunk-U4JIA3BF.js";
import "./chunk-Y6I7Q6GR.js";
import {
  addEffect,
  context,
  createPortal,
...
async function injectEmulator(store, emulateOptions, alert) {
  ...
  const { emulate } = await import("./emulate-22MRWTWU.js");
  if (alert) {
...
var useIsomorphicLayoutEffect = typeof window !== "undefined" && ((_window$document = window.document) != null && _window$document.createElement || ((_window$navigator = window.navigator) == null ? void 0 : _window$navigator.product) === "ReactNative") ? import_react18.default.useLayoutEffect : import_react18.default.useEffect;
function tunnel() {
  ...
  return {
    In: ({
      ...
      const version = useStore3((state) => state.version);
    ...
    Out: () => {
      ...
      return import_react18.default.createElement(import_react18.default.Fragment, null, current);
    }
  };
}
